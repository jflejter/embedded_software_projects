...
void LcdRenderObject(Int Object, Int PosX, Int PosY, Bool RenderFlag)
{
	...
	{
	case LCD_OBJ_PADDLE:
		ObjectPixelWidth = LCD_PADDLE_PIXEL_WIDTH;
		ObjectPixelHeight = LCD_PADDLE_PIXEL_HEIGHT;
		break;

	case LCD_OBJ_BALL:
		ObjectPixelWidth = LCD_BALL_PIXEL_WIDTH;
		ObjectPixelHeight = LCD_BALL_PIXEL_HEIGHT;
		break;
	}
