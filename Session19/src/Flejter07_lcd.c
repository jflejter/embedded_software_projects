...
#define CHAR_PIXEL_WIDTH	6		// width of a character, in pixels

//eprintf #defines
#define HEX_LCASE_OFFSET	16
...
void LcdInit(void)
{
	...
	// Temporary variables for setting the character column and row
	int CharCol = 0;
	int CharRow = 0;
	...
	// Test the function to reverse the pixels
	LcdReverse(FALSE);

	//
	// Temporary code for testing character rendering
	//
	...
	// Render characters starting at the column and row
	//CharWrite('A');
	//CharWrite('B');
	//CharWrite('C');
...
int LcdPrintf(int CharRow, int CharCol, char * FmtStrPtr, ...)
{
	...
	//return 0;	// for now, to avoid compiler warning
	va_list		ArgPtr;
	Bool		IsHexLower;
